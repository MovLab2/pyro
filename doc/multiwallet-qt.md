...
Only requiring some minor changes is pyro.cpp.
...
Changes to pyro.cpp
----------------------
pyro.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
