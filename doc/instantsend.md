...
This mechanism has been integrated into Bitcore-Node-PYRO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pyrocoin/insight-api-pyro#web-socket-api](https://github.com/pyrocoin/insight-api-pyro#web-socket-api) 
* API: [https://github.com/pyrocoin/insight-api-pyro#instantsend-transactions](https://github.com/pyrocoin/insight-api-pyro#instantsend-transactions) 
...
By default, the PYRO Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PYRO Core daemon:
