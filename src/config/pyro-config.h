/* src/config/pyro-config.h.  Generated from pyro-config.h.in by configure.  */
/* src/config/pyro-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GOBYTE_CONFIG_H

#define GOBYTE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/pyrocoin/pyro/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PYRO Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PYRO Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "pyrocore"
