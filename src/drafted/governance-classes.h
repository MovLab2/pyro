 ...
 *
 *   // network
 *   CPYRONetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.pyro.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPYRONetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PYRONetwork
// //   -- signature requirements : Key1(User)
// class CPYRONetworkVariable : public CGovernanceObject
// {
// private:
