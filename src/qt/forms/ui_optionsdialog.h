...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start PYRO Core after logging in to the system.", nullptr));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start PYRO Core on system login", nullptr));
...
#ifndef QT_NO_TOOLTIP
        showAdvancedPSUI->setToolTip(QApplication::translate("OptionsDialog", "Show additional information and buttons for PrivateSend on overview screen.", nullptr));
#endif // QT_NO_TOOLTIP
        showAdvancedPSUI->setText(QApplication::translate("OptionsDialog", "Enable advanced PrivateSend interface", nullptr));
#ifndef QT_NO_TOOLTIP
        lowKeysWarning->setToolTip(QApplication::translate("OptionsDialog", "Show warning dialog when PrivateSend detects that wallet has very low number of keys left.", nullptr));
#endif // QT_NO_TOOLTIP
        lowKeysWarning->setText(QApplication::translate("OptionsDialog", "Warn if PrivateSend is running out of keys", nullptr));
#ifndef QT_NO_TOOLTIP
        privateSendMultiSession->setToolTip(QApplication::translate("OptionsDialog", "Whether to use experimental PrivateSend mode with multiple mixing sessions per block.<br/>Note: You must use this feature carefully.<br/>Make sure you always have recent wallet (auto)backup in a safe place!", nullptr));
#endif // QT_NO_TOOLTIP
        privateSendMultiSession->setText(QApplication::translate("OptionsDialog", "Enable PrivateSend &multi-session", nullptr));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("OptionsDialog", "This setting determines the amount of individual masternodes that an input will be anonymized through.<br/>More rounds of anonymization gives a higher degree of privacy, but also costs more in fees.", nullptr));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OptionsDialog", "PrivateSend rounds to use", nullptr));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("OptionsDialog", "This amount acts as a threshold to turn off PrivateSend once it's reached.", nullptr));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of PYRO to keep anonymized", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tabWallet), QApplication::translate("OptionsDialog", "W&allet", nullptr));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the PYRO Core client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the PYRO network through a SOCKS5 proxy.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the PYRO network through a separate SOCKS5 proxy for Tor hidden services.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting PYRO Core.", nullptr));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/projects/p/pyro/", nullptr));
...
#ifndef QT_NO_TOOLTIP
        thirdPartyTxUrlsLabel->setToolTip(QApplication::translate("OptionsDialog", "Third party URLs (e.g. a block explorer) that appear in the transactions tab as context menu items.<br/>%s in the URL is replaced by transaction hash. Multiple URLs are separated by vertical bar |.", nullptr));
#endif // QT_NO_TOOLTIP
        thirdPartyTxUrlsLabel->setText(QApplication::translate("OptionsDialog", "Third party transaction URLs", nullptr));
#ifndef QT_NO_TOOLTIP
        thirdPartyTxUrls->setToolTip(QApplication::translate("OptionsDialog", "Third party URLs (e.g. a block explorer) that appear in the transactions tab as context menu items.<br/>%s in the URL is replaced by transaction hash. Multiple URLs are separated by vertical bar |.", nullptr));
#endif // QT_NO_TOOLTIP
