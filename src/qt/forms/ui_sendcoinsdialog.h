...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 PYRO"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 PYRO"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 PYRO"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 PYRO"));
        ...
        labelBalance->setText(QStringLiteral("123.456 PYRO"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 duffs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 duffs in fee,<br />while \"at least\" pays 1000 duffs. For transactions bigger than a kilobyte both pay by kilobyte.", nullptr));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", nullptr));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 duffs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 duffs in fee,<br />while \"total at least\" pays 1000 duffs. For transactions bigger than a kilobyte both pay by kilobyte.", nullptr));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", nullptr));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for pyro transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for pyro transactions than the network can process.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        checkUsePrivateSend->setText(QApplication::translate("SendCoinsDialog", "PrivateSend", nullptr));
        checkUseInstantSend->setText(QApplication::translate("SendCoinsDialog", "InstantSend", nullptr));
