    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("PYRO Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About PYRO Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pyro-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the PYRO in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PYRO, 0.1 PYRO, 1 PYRO and 10 PYRO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://pyrocoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://pyrocoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("PYRO Core is shutting down...") + "<br /><br />" +
