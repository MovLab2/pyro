    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("PYRO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PYRO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pyro: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About PYRO Core"), this);
    aboutAction->setStatusTip(tr("Show information about PYRO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PYRO Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PYRO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PYRO addresses"));
    ...
    openAction->setStatusTip(tr("Open a pyro: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PYRO Core help message to get a list with possible PYRO Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PYRO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PYRO network", "", count));
}
...
{
    QString strTitle = tr("PYRO Core"); // default title
