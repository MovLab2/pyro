    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PYRO-light"), QVariant("light"));
    ui->theme->addItem(QString("PYRO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PYRO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PYRO-traditional"), QVariant("trad"));
